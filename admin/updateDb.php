           ...
           <div class="mainBodyContentContainer">
                <div class="settingsPage updateSettings">
                    <div class="heading flex">
                        ...
                        <button class="btn">
                            <a href="db.php" class="flex">All Delivery <i class="uil uil-arrow-right icon"></i></a>
                        </button>
                    </div>
                        ...
                        <form method="post" enctype="multipart/form-data" class="flex">
                            ...
                            <div class="grid">
                                ...
                                <span class="flex span">
                                    ...
                                    <button class="btn bg" name="submit">Update Delivery</button>
                            </div>
                        </form>
...
if(isset($_POST['submit'])){
  ...
  if($result == TRUE){
    $_SESSION['dbUpdated'] = '<span class="success">Delivery Updated Successfully!</span>';
