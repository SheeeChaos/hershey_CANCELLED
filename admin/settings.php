...
if (!isset($_SESSION['username'])) {
    // If the session doesn't exist, redirect to the login page outside the admin directory
            ...
            <div class="settingsPage">
                <div class="heading flex">
                    ...
                    <span class="flex" style="gap: 1rem;">
                        ...
                        <button class="btn">
                            <a href="addDb.php" class="flex">Add Delivery<i class="uil uil-plus icon"></i></a>
                        </button>
                        <button class="btn">
