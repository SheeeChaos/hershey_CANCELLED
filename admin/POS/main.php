...
<body id="body">
	<div class="h-100 bg-dark" id="container">
		<div id="header" style="display: flex; width:100%;">
			...
			<div>
				<img class="img-fluid m-2 w-100" src="assests/logo2.jpg" style="width: 200px;"/>
			</div>
    ...
    height: 50px;" class="cancel btn btn-secondary border  ml-5"><i class="fas fa-print"></i> Print Token</button>
		...
		<div id="footer" class="w-100" style="display: flex; width:100%">
			<button id="buttons" style="flex-grow: 1;" onclick="window.location.href='user/profile.php'" class="btn btn-secondary border mr-2 ml-2"><i class="fas fa-users"></i> User</button>
