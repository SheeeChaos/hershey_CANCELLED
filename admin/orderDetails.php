         ...
         <div class="mainBody">
            ...
            <div class="mainBodyContentContainer">
                ...
                <div class="heading flex">
                    ...
                    <button class="btn">
                        <a href="orders.php" class="flex">All Orders <i class="uil uil-arrow-right icon"></i></a>
                    </button>
                </div>
                ...
                <div class="customerDetails grid">
                    ...
                    <div class="singleDetail flex">
                        <span class="dTitle">Cust. Full Name:-</span>
                        <span class="detail"><?php echo $Fname;?></span>
                    </div>
                    ...
                    <div class="singleDetail  flex">
                        ...
                        <span class="detail" ><?php echo $houseNo;?></span>
                    </div>
                    <div class="singleDetail  flex">
                    ...
                    <div class="singleDetail  flex">
                        <span class="dTitle">Store:-</span>
                        <span class="detail" ><?php echo $image;?></span>
                    </div>
                </div>
                                  ...
                                  while($row = mysqli_fetch_assoc($res)){
                                    ...
                                    ?>
                                      <div class="singleCart flex">
                                        ...
                                        if($image!=""){   
                                        ?>
                                        <img src="<?php echo SITEURL;?>databaseImages/foodie<?php echo $image;?>">
